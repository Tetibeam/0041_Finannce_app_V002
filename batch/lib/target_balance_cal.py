...
def set_monthly_balance_by_repeat_setting(df_cross: pd.DataFrame, verbose: bool=False):
...
def set_annually_balance_by_repeat_setting(df_cross: pd.DataFrame, verbose: bool=False):
...
def set_every_2_years_balance_by_repeat_setting(df_cross: pd.DataFrame, verbose: bool=False):
...
def set_every_3_years_balance_by_repeat_setting(df_cross: pd.DataFrame, verbose: bool=False):
...
def set_specific_balance_by_repeat_setting(df_cross: pd.DataFrame, verbose: bool=False):
...
def cal_balance_target(df_cross):
    FUNCTIONS = [
        set_monthly_balance_by_repeat_setting,
...
def clear_duplicated_balance_data(df_balance):
    """
...
def finalize_balance(df_balance):
...
def build_balance_target(df_raw, start, end):
    ...
    df_balance = (
        cal_balance_target(df_cross)
        .pipe(clear_duplicated_balance_data)
        .pipe(finalize_balance)
    )
    return df_balance